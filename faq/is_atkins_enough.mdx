...
Atkins is a well-written textbook that introduces all of the necessary fundamentals of Chemistry for the USNCO[^1] exam.
...
>
> 1. organic chemistry, which you should read Klein's Organic Chemistry[^2] to learn
